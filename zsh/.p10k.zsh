# Generated by Powerlevel10k configuration wizard on 2020-04-09 at 21:37 PDT.
...
# 24h time, 2 lines, solid, no frame, black-ornaments, sparse, few icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=237 # gruvbox bg1
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=237 # gruvbox bg1
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION="$i_fa_th_list "
